...
class IvYGAP_Dataset(Dataset):
    ...
    def label_generation(self,index):
        ...
        list_labels=np.asarray([temp,temp,temp,temp,label_Grade, label_Diag, temp, label_Subtype, label_survival, label_censor, label_event])
...
class TCGA_Dataset(Dataset):
    ...
    def label_generation(self,index):
        ...
        list_labels=np.asarray([label_IDH,label_1p19q,label_CDKN,label_His,label_Grade,label_Diag,label_His_2class, label_Subtype, label_survival, label_censor, label_event])
